<?php
    ...
    if(isset($_POST['send'])) {
        ...
        include_once("onfig.php");
        $result = mysqli_query($mysqli, "INSERT INTO komentar(nama,email,komentar,tanggal) VALUES('$name','$email','$subject','$tanggal')"); 
                             ...
                             <ul class="navbar-nav ml-auto">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        ...
                                        <a class="dropdown-item" href="KONTAK_PA.php">Kontak</a>
                                    </div>
                                </li>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-10 col-lg-8">
                    <div class="contact-form">
                        <h5>Hubungi Kami</h5>
                        <!-- Contact Form -->
                        <form action="KONTAK_PA.php" method="POST">
                            <div class="row">
                                ...
                                <div class="col-12">
                                    <div class="group">
                                        ...
                                        <span class="highlight"></span>
                                        <span class="bar"></span>
                                        <label>Masukka Pesan dan Saran anda</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <button type="submit" class="btn world-btn" name="send" style="background-color: black">Send</button>
                                </div>
                            </div>
                        </form>
                    </div>
