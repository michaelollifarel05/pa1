...
<?php
    ...
    if(isset($_POST['send'])) {
        $name = $_POST['Judul'];
        $email = $_POST['tahun'];
        $result = mysqli_query($mysqli, "INSERT INTO istas (judul,tahun) VALUES('$name','$email')"); 
...
<body>
	...
	<div class="container">
		...
		<div class="content">
			    ...
			    <tbody>
			       ...
			       settype($var,'integer');
			        ...
			        while($komen = mysqli_fetch_array($query)){
			            ...
			            echo "<td>";
			            echo "<a href='hapusIstas.php?id=".$komen['id']."'>Hapus</a>";
			...
			<div>
				<form action="TampilanIstas.php" method="POST">
