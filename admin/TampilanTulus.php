...
<?php
    ...
    if(isset($_POST['send'])) {
        $name = $_POST['Judul'];
        $email = $_POST['tahun'];
        $result = mysqli_query($mysqli, "INSERT INTO tulus (judul,tahun) VALUES('$name','$email')"); 
	...
	<div class="container">
		...
		<div class="content">
			<div class="containersassd">
  				...
  				<hr>
  				<h4>Tulus Pardamean Simajuntak</h4>
			    ...
			    <tbody>
			       ...
			       settype($var,'integer');
			        ...
			        while($komen = mysqli_fetch_array($query)){
			            ...
			            echo "<td>";
			            echo "<a href='hapusTulus.php?id=".$komen['id']."'>Hapus</a>";
			...
			<div>
				<form action="TampilanTulus.php" method="POST">
