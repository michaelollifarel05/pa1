...
<?php
    ...
    if(isset($_POST['send'])) {
        $name = $_POST['Judul'];
        $email = $_POST['tahun'];
        $result = mysqli_query($mysqli, "INSERT INTO fica (judul,tahun) VALUES('$name','$email')"); 
	...
	<div class="container">
		...
		<div class="content">
			<div class="containersassd">
  				...
  				<hr>
  				<h4>Fica Aida Nadhifatul Aini</h4>
			    ...
			    <tbody>
			       ...
			       settype($var,'integer');
			        ...
			        while($komen = mysqli_fetch_array($query)){
			            ...
			            echo "<td>";
			            echo "<a href='hapusFica.php?id=".$komen['id']."'>Hapus</a>";
			...
			<div>
				<form action="TampilanFica.php" method="POST">
